...
public class BFS {
    ...
    private static boolean fillAllowed;
    private static boolean isPassable(MapLocation loc) throws GameActionException {
    ...
    public static Direction getDir(MapLocation target, boolean allowFill) throws GameActionException {
        ...
        if (rc.onTheMap(l111)) { // check (-1, 0)
            if (rc.canSenseLocation(l111) && isPassable(l111)) { 
        ...
        if (rc.onTheMap(l97)) { // check (0, -1)
            if (rc.canSenseLocation(l97) && isPassable(l97)) { 
        ...
        if (rc.onTheMap(l127)) { // check (0, 1)
            if (rc.canSenseLocation(l127) && isPassable(l127)) { 
        ...
        if (rc.onTheMap(l113)) { // check (1, 0)
            if (rc.canSenseLocation(l113) && isPassable(l113)) { 
        ...
        if (rc.onTheMap(l96)) { // check (-1, -1)
            if (rc.canSenseLocation(l96) && isPassable(l96)) { 
        ...
        if (rc.onTheMap(l126)) { // check (-1, 1)
            if (rc.canSenseLocation(l126) && isPassable(l126)) { 
        ...
        if (rc.onTheMap(l98)) { // check (1, -1)
            if (rc.canSenseLocation(l98) && isPassable(l98)) { 
        ...
        if (rc.onTheMap(l128)) { // check (1, 1)
            if (rc.canSenseLocation(l128) && isPassable(l128)) { 
        ...
        if (rc.onTheMap(l110)) { // check (-2, 0)
            if (rc.canSenseLocation(l110) && isPassable(l110)) { 
        ...
        if (rc.onTheMap(l82)) { // check (0, -2)
            if (rc.canSenseLocation(l82) && isPassable(l82)) { 
                if (d82 > d97) { // from (0, -1)
                    d82 = d97;
                }
                if (d82 > d96) { // from (-1, -1)
        ...
        if (rc.onTheMap(l142)) { // check (0, 2)
            if (rc.canSenseLocation(l142) && isPassable(l142)) { 
        ...
        if (rc.onTheMap(l114)) { // check (2, 0)
            if (rc.canSenseLocation(l114) && isPassable(l114)) { 
        ...
        if (rc.onTheMap(l95)) { // check (-2, -1)
            if (rc.canSenseLocation(l95) && isPassable(l95)) { 
        ...
        if (rc.onTheMap(l125)) { // check (-2, 1)
            if (rc.canSenseLocation(l125) && isPassable(l125)) { 
        ...
        if (rc.onTheMap(l81)) { // check (-1, -2)
            if (rc.canSenseLocation(l81) && isPassable(l81)) { 
                if (d81 > d97) { // from (0, -1)
                    d81 = d97;
                }
                if (d81 > d96) { // from (-1, -1)
        ...
        if (rc.onTheMap(l141)) { // check (-1, 2)
            if (rc.canSenseLocation(l141) && isPassable(l141)) { 
        ...
        if (rc.onTheMap(l83)) { // check (1, -2)
            if (rc.canSenseLocation(l83) && isPassable(l83)) { 
                if (d83 > d97) { // from (0, -1)
                    d83 = d97;
                }
                if (d83 > d98) { // from (1, -1)
        ...
        if (rc.onTheMap(l143)) { // check (1, 2)
            if (rc.canSenseLocation(l143) && isPassable(l143)) { 
        ...
        if (rc.onTheMap(l99)) { // check (2, -1)
            if (rc.canSenseLocation(l99) && isPassable(l99)) { 
        ...
        if (rc.onTheMap(l129)) { // check (2, 1)
            if (rc.canSenseLocation(l129) && isPassable(l129)) { 
        ...
        if (rc.onTheMap(l80)) { // check (-2, -2)
            if (rc.canSenseLocation(l80) && isPassable(l80)) { 
                if (d80 > d96) { // from (-1, -1)
                    d80 = d96;
                }
                if (d80 > d95) { // from (-2, -1)
        ...
        if (rc.onTheMap(l140)) { // check (-2, 2)
            if (rc.canSenseLocation(l140) && isPassable(l140)) { 
        ...
        if (rc.onTheMap(l84)) { // check (2, -2)
            if (rc.canSenseLocation(l84) && isPassable(l84)) { 
                if (d84 > d98) { // from (1, -1)
                    d84 = d98;
                }
                if (d84 > d83) { // from (1, -2)
        ...
        if (rc.onTheMap(l144)) { // check (2, 2)
            if (rc.canSenseLocation(l144) && isPassable(l144)) { 
        ...
        if (rc.onTheMap(l109)) { // check (-3, 0)
            if (rc.canSenseLocation(l109) && isPassable(l109)) { 
        ...
        if (rc.onTheMap(l67)) { // check (0, -3)
            if (rc.canSenseLocation(l67) && isPassable(l67)) { 
                if (d67 > d82) { // from (0, -2)
                    d67 = d82;
                }
                if (d67 > d81) { // from (-1, -2)
        ...
        if (rc.onTheMap(l157)) { // check (0, 3)
            if (rc.canSenseLocation(l157) && isPassable(l157)) { 
        ...
        if (rc.onTheMap(l115)) { // check (3, 0)
            if (rc.canSenseLocation(l115) && isPassable(l115)) { 
        ...
        if (rc.onTheMap(l94)) { // check (-3, -1)
            if (rc.canSenseLocation(l94) && isPassable(l94)) { 
        ...
        if (rc.onTheMap(l124)) { // check (-3, 1)
            if (rc.canSenseLocation(l124) && isPassable(l124)) { 
        ...
        if (rc.onTheMap(l66)) { // check (-1, -3)
            if (rc.canSenseLocation(l66) && isPassable(l66)) { 
                if (d66 > d82) { // from (0, -2)
                    d66 = d82;
                }
                if (d66 > d81) { // from (-1, -2)
        ...
        if (rc.onTheMap(l156)) { // check (-1, 3)
            if (rc.canSenseLocation(l156) && isPassable(l156)) { 
        ...
        if (rc.onTheMap(l68)) { // check (1, -3)
            if (rc.canSenseLocation(l68) && isPassable(l68)) { 
                if (d68 > d82) { // from (0, -2)
                    d68 = d82;
                }
                if (d68 > d83) { // from (1, -2)
        ...
        if (rc.onTheMap(l158)) { // check (1, 3)
            if (rc.canSenseLocation(l158) && isPassable(l158)) { 
        ...
        if (rc.onTheMap(l100)) { // check (3, -1)
            if (rc.canSenseLocation(l100) && isPassable(l100)) { 
        ...
        if (rc.onTheMap(l130)) { // check (3, 1)
            if (rc.canSenseLocation(l130) && isPassable(l130)) { 
        ...
        if (rc.onTheMap(l79)) { // check (-3, -2)
            if (rc.canSenseLocation(l79) && isPassable(l79)) { 
                if (d79 > d95) { // from (-2, -1)
                    d79 = d95;
                }
                if (d79 > d80) { // from (-2, -2)
        ...
        if (rc.onTheMap(l139)) { // check (-3, 2)
            if (rc.canSenseLocation(l139) && isPassable(l139)) { 
        ...
        if (rc.onTheMap(l65)) { // check (-2, -3)
            if (rc.canSenseLocation(l65) && isPassable(l65)) { 
                if (d65 > d81) { // from (-1, -2)
                    d65 = d81;
                }
                if (d65 > d80) { // from (-2, -2)
        ...
        if (rc.onTheMap(l155)) { // check (-2, 3)
            if (rc.canSenseLocation(l155) && isPassable(l155)) { 
        ...
        if (rc.onTheMap(l69)) { // check (2, -3)
            if (rc.canSenseLocation(l69) && isPassable(l69)) { 
                if (d69 > d83) { // from (1, -2)
                    d69 = d83;
                }
                if (d69 > d84) { // from (2, -2)
        ...
        if (rc.onTheMap(l159)) { // check (2, 3)
            if (rc.canSenseLocation(l159) && isPassable(l159)) { 
        ...
        if (rc.onTheMap(l85)) { // check (3, -2)
            if (rc.canSenseLocation(l85) && isPassable(l85)) { 
                if (d85 > d99) { // from (2, -1)
                    d85 = d99;
                }
                if (d85 > d84) { // from (2, -2)
        ...
        if (rc.onTheMap(l145)) { // check (3, 2)
            if (rc.canSenseLocation(l145) && isPassable(l145)) { 
        ...
        if (rc.onTheMap(l108)) { // check (-4, 0)
            if (rc.canSenseLocation(l108) && isPassable(l108)) { 
        ...
        if (rc.onTheMap(l52)) { // check (0, -4)
            if (rc.canSenseLocation(l52) && isPassable(l52)) { 
                if (d52 > d67) { // from (0, -3)
                    d52 = d67;
                }
                if (d52 > d66) { // from (-1, -3)
        ...
        if (rc.onTheMap(l172)) { // check (0, 4)
            if (rc.canSenseLocation(l172) && isPassable(l172)) { 
        ...
        if (rc.onTheMap(l116)) { // check (4, 0)
            if (rc.canSenseLocation(l116) && isPassable(l116)) { 
        ...
        if (rc.onTheMap(l93)) { // check (-4, -1)
            if (rc.canSenseLocation(l93) && isPassable(l93)) { 
        ...
        if (rc.onTheMap(l123)) { // check (-4, 1)
            if (rc.canSenseLocation(l123) && isPassable(l123)) { 
        ...
        if (rc.onTheMap(l51)) { // check (-1, -4)
            if (rc.canSenseLocation(l51) && isPassable(l51)) { 
                if (d51 > d67) { // from (0, -3)
                    d51 = d67;
                }
                if (d51 > d66) { // from (-1, -3)
        ...
        if (rc.onTheMap(l171)) { // check (-1, 4)
            if (rc.canSenseLocation(l171) && isPassable(l171)) { 
        ...
        if (rc.onTheMap(l53)) { // check (1, -4)
            if (rc.canSenseLocation(l53) && isPassable(l53)) { 
                if (d53 > d67) { // from (0, -3)
                    d53 = d67;
                }
                if (d53 > d68) { // from (1, -3)
        ...
        if (rc.onTheMap(l173)) { // check (1, 4)
            if (rc.canSenseLocation(l173) && isPassable(l173)) { 
        ...
        if (rc.onTheMap(l101)) { // check (4, -1)
            if (rc.canSenseLocation(l101) && isPassable(l101)) { 
        ...
        if (rc.onTheMap(l131)) { // check (4, 1)
            if (rc.canSenseLocation(l131) && isPassable(l131)) { 
        ...
        if (rc.onTheMap(l64)) { // check (-3, -3)
            if (rc.canSenseLocation(l64) && isPassable(l64)) { 
                if (d64 > d80) { // from (-2, -2)
                    d64 = d80;
                }
                if (d64 > d79) { // from (-3, -2)
        ...
        if (rc.onTheMap(l154)) { // check (-3, 3)
            if (rc.canSenseLocation(l154) && isPassable(l154)) { 
        ...
        if (rc.onTheMap(l70)) { // check (3, -3)
            if (rc.canSenseLocation(l70) && isPassable(l70)) { 
                if (d70 > d84) { // from (2, -2)
                    d70 = d84;
                }
                if (d70 > d69) { // from (2, -3)
        ...
        if (rc.onTheMap(l160)) { // check (3, 3)
            if (rc.canSenseLocation(l160) && isPassable(l160)) { 
        ...
        if (rc.onTheMap(l78)) { // check (-4, -2)
            if (rc.canSenseLocation(l78) && isPassable(l78)) { 
                if (d78 > d94) { // from (-3, -1)
                    d78 = d94;
                }
                if (d78 > d79) { // from (-3, -2)
        ...
        if (rc.onTheMap(l138)) { // check (-4, 2)
            if (rc.canSenseLocation(l138) && isPassable(l138)) { 
        ...
        if (rc.onTheMap(l50)) { // check (-2, -4)
            if (rc.canSenseLocation(l50) && isPassable(l50)) { 
                if (d50 > d66) { // from (-1, -3)
                    d50 = d66;
                }
                if (d50 > d65) { // from (-2, -3)
        ...
        if (rc.onTheMap(l170)) { // check (-2, 4)
            if (rc.canSenseLocation(l170) && isPassable(l170)) { 
        ...
        if (rc.onTheMap(l54)) { // check (2, -4)
            if (rc.canSenseLocation(l54) && isPassable(l54)) { 
                if (d54 > d68) { // from (1, -3)
                    d54 = d68;
                }
                if (d54 > d69) { // from (2, -3)
        ...
        if (rc.onTheMap(l174)) { // check (2, 4)
            if (rc.canSenseLocation(l174) && isPassable(l174)) { 
        ...
        if (rc.onTheMap(l86)) { // check (4, -2)
            if (rc.canSenseLocation(l86) && isPassable(l86)) { 
        ...
        if (rc.onTheMap(l146)) { // check (4, 2)
            if (rc.canSenseLocation(l146) && isPassable(l146)) { 
